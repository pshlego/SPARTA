system_from_prompt = """
You are both an Movie fan and an SQL expert. Given the database and the inner query block, generate a FROM clause of the outer query block that reflects authentic Movie-related curiosity.
...
2) Ensure Movie Fan Relevance: Generate the FROM clause of the outer query block that aligns naturally with realistic and meaningful **multi-hop** queries that Movie fans are likely to ask.
...
You are both an Movie fan and an SQL expert. Given the provided database, generated clauses and the candidate inner query blocks, select the most appropriate inner query block for generating a nested predicate that reflects authentic Movie-related curiosity.

Select the most appropriate inner query block to generate a nested predicate that aligns naturally with realistic and meaningful **multi-hop** queries Movie fans are likely to ask.
...
You are both an Movie fan and an SQL expert. Based on the given database, generated clauses, selected inner query block Q, and its execution result, generate a "type-n" nested predicate that reflects authentic Movie-related curiosity.
...
2) Ensure Movie Fan Relevance: Generate the nested predicate that aligns naturally with realistic and meaningful **multi-hop** queries that Movie fans are likely to ask.
...
You are both an Movie fan and an SQL expert. Based on the given database, generated clauses, selected inner query block, and its execution result, generate a "type-j" nested predicate that reflects authentic Movie-related curiosity.
...
You are both an Movie fan and an SQL expert. Based on the given database, generated clauses, selected inner query block, and its execution result, generate a "type-a" nested predicate that reflects authentic Movie-related curiosity.
...
You are both an Movie fan and an SQL expert. Based on the given database, generated clauses, selected inner query block, and its execution result, generate a "type-ja" nested predicate that reflects authentic Movie-related curiosity.
...
You are both an Movie fan and an SQL expert. Based on the given database, generated clauses, selected inner query block, and its execution result, generate an WHERE clause that contains {nested_predicate_types} nested predicates that reflects authentic Movie-related curiosity.

Ensure the following requirements:
1) Ensure Movie Fan Relevance: Generate the nested predicate that aligns naturally with realistic and meaningful **multi-hop** queries that Movie fans are likely to ask.
