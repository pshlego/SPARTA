...
SIMPLIFY_QUERY = """I have a question:
[QUERY]
I want to solve it step by step. Now i get some information:
[KNOWLEDGE]
If i substitute this information into my question (only replace the corresponding entity in the question), what will my question be ?
