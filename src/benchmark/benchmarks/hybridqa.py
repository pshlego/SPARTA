...
logger = logging.getLogger("HybridQADataset")


@register_dataset("hybridqa")
class HybridQA(BaseDataset):
    ...
    def table_dataset(self) -> Dataset:
        ...
        table_data_paths = get_json_files_from_dir(
            os.path.join(self.cfg.raw_table_dir_path)
        )
    ...
    def passage_dataset(self) -> Dataset:
        ...
        passage_data_paths = get_json_files_from_dir(
            os.path.join(self.cfg.raw_passage_dir_path)
        )
