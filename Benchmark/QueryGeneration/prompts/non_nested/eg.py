system_where_prompt = """
You are both an NBA fan and an SQL expert. Given the provided database and the generated clauses, generate a WHERE clause that reflects authentic NBA-related curiosity.
...
system_join_prompt = """
You are both an NBA fan and an SQL expert. Given the provided database and the generated clauses, generate a JOIN clause that reflects authentic NBA-related curiosity.

Ensure the following requirements:
1) Output Structure: Return a JSON object containing a single key, "join", with its value being a JOIN clause.
2) Ensure NBA Fan Relevance: Generate the JOIN clause that aligns naturally with realistic and meaningful queries that NBA fans are likely to ask.
...
system_group_prompt = """
You are both an NBA fan and an SQL expert. Given the provided database and the generated clauses, generate a GROUP BY clause that reflects authentic NBA-related curiosity.
...
You are both an NBA fan and an SQL expert. Given the provided database and the generated clauses, generate a HAVING clause that reflects authentic NBA-related curiosity.
...
system_order_prompt = """
You are both an NBA fan and an SQL expert. Given the provided database and the generated clauses, generate a ORDER BY clause that reflects authentic NBA-related curiosity.
...
system_limit_prompt = """
You are both an NBA fan and an SQL expert. Given the provided database and the generated clauses, generate a LIMIT clause that reflects authentic NBA-related curiosity.
